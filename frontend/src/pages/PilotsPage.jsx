            ...
            {showForm && (
                <div className="modal">
                    <div className="modal-content">
                        ...
                        <h2>{editingPilot ? 'Редактировать пилота' : 'Добавить пилота'}</h2>
                        <form onSubmit={handleSubmit} className="pilot-form">
                            ...
                            <div className="form-section">
                                ...
                                <div className="form-group">
                                    <label htmlFor="raceHistory">История участий (JSON)</label>
                                    <textarea
                                        id="raceHistory"
                                        name="raceHistory"
                                        value={formData.raceHistory}
                                        onChange={handleInputChange}
                                        placeholder='[{"date": "2024-03-15", "name": "Гран-при Австралии", "position": 1, "licensePoints": 25}]'
                                        rows="5"
                                    />
                                    <small>Формат: массив объектов с полями date, name, position, licensePoints</small>
                                </div>
                            </div>
